            ...
            return (
                ...
                (j.prototype.updateScrollValues = function () {
                    ...
                    (a = this.content),
                        ...
                        "same" !== b && this.$el.trigger("update", { position: this.contentScrollTop, maximum: this.maxScrollTop, direction: b }),
                        this.iOSNativeScrolling || ((this.maxSliderTop = this.paneHeight - this.sliderHeight), (this.sliderTop = 0 === this.maxScrollTop ? 0 : (this.contentScrollTop * this.maxSliderTop) / this.maxScrollTop));
                }),
                (j.prototype.setOnScrollStyles = function () {
                    var a;
                    B ? ((a = {}), (a[E] = "translate(0, " + this.sliderTop + "px)")) : (a = { top: this.sliderTop }),
                        D
                ...
                (j.prototype.createEvents = function () {
                    this.events = {
                        ...
                        drag: (function (a) {
                            return function (b) {
                                return (
                                    (a.sliderY = b.pageY - a.$el.offset().top - a.paneTop - (a.offsetY || 0.5 * a.sliderHeight)),
                                    a.scroll(),
                        ...
                        panedown: (function (a) {
                            return function (b) {
                                return (a.sliderY = (b.offsetY || b.originalEvent.layerY) - 0.5 * a.sliderHeight), a.scroll(), a.events.down(b), !1;
                            };
                        })(this),
                        scroll: (function (a) {
                            return function (b) {
                                a.updateScrollValues(),
                                    a.isBeingDragged ||
                                        (a.iOSNativeScrolling || ((a.sliderY = a.sliderTop), a.setOnScrollStyles()),
                                        null != b &&
                ...
                (j.prototype.reset = function () {
                    ...
                    return this.iOSNativeScrolling
                        ...
                        : (this.$el.find("." + this.options.paneClass).length || this.generate().stop(),
                          ...
                          l > 0 && (this.$el.height(""), this.$el.height(a.scrollHeight > l ? l : a.scrollHeight)),
